        ...
        <div className='countryCard' style={{margin:'0',padding:'20px',display:'flex',flexDirection:'column',alignItems:'center'}}>
            ...
            <div style={{display:'flex',flexWrap:'wrap',gap:'20px',justifyContent:'center'}}>
                {filteredCountries.map(country=>(
                    <div key={country.cca3} className='countryCard' style={{display:'flex',flexDirection:'column',width:'100px',borderRadius:'8px',padding:'10px'}}>
                        ...
                        <span style={{margin:'0',fontSize:'10px',textAlign:'center'}} className='countryCard'>{country.name.common}</span>
                    </div>
                ))}
            </div>
        </div>
